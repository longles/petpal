...
const NavBar = () => {
    ...
    const renderShelterNavbar = () => (
        <>
            ...
            <li className="nav-item">
                <Link className="nav-link active" to={`/shelterdetail/${localStorage.user_object_id}`}>View
                    Shelter</Link>
            </li>
            <li className="nav-item">
        ...
        <>
            <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="profileDropdown">
                    ...
                    <li>
                        <button className="dropdown-item btn" onClick={logoutFunc}>Logout</button>
                    </li>
                </ul>
            </li>
        </>
                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul className="navbar-nav ml-auto">
                            ...
                            {userType !== 'none' && renderProfile(userType)}
                        </ul>
                    </div>
                </div>
            </nav>
            {userType !== 'none' &&
                <NotificationModal showModal={showNotifications} setShowModal={setShowNotifications}/>}
        </>
